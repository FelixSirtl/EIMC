...
{
    public interface IAttributeCheckOperator : IAttributeFilterOperator
    {
        new void AttributeFilterSet(SetSymbol parameterSym1, PredicateNode predicateNode, SetSymbol returnSym);
    }
}
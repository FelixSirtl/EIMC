...
namespace QL4BIMinterpreter
{
    public interface IDeassociaterOperator
    {
        ...
        IEnumerable<QLEntites> GetTuplesRelAtt(IEnumerable<QLEntites> tuples, int attributeIndex, string[] exAtts);
        IEnumerable<QLEntites> GetTuplesSet(IEnumerable<QLEntity> entites, string[] exAtts);
    }
}

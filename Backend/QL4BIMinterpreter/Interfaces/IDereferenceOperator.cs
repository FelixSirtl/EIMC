...
namespace QL4BIMinterpreter
{
    public interface IDereferenceOperator
    {
        ...
        List<QLEntites> ResolveReferenceTuplesIn(IEnumerable<QLEntites> tuples, int attributeIndex, bool replace, string referenceName);
        IEnumerable<QLEntites> ResolveReferenceSetIn(IEnumerable<QLEntity> entites, string referenceName);
    }
}

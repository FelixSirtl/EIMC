...
{   
    ...
    public class P21Reader : IP21Reader
    {
        ...
        private void LoadSchema()
        {
            ...
            var schemaLines = new string[] { };
            try
            {
                 schemaLines = File.ReadAllLines(schemaFilename).ToArray();
            }
            catch (Exception)
            {
                Console.WriteLine("Schema file for IfcEngine and QL not found");
                throw;
            }
        ...
        public QLEntites LoadIfcFile(string ifcFilename)
        {
            ...
            return new QLEntites(entitiesWithPropNames);
        }

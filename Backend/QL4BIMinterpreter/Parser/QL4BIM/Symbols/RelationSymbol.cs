...
namespace QL4BIMinterpreter.QL4BIM
{
    public class RelationSymbol : Symbol
    {
        ...
        public RelationSymbol(RelationNode node) : base(node)
        {
            ...
            tuples = new List<QLEntites>();
            Header = "Relation->";
        }

        public void AddTuple(QLEntites tuple)
        {
            HandleAttributeCount(tuple);
            tuples.Add(tuple);
        }

        private void HandleAttributeCount(QLEntites tuple)
        {
        ...
        public void SetTuples(IEnumerable<QLEntites> entityTuples)
        {
        ...
        public sealed override IEnumerable<QLEntites> Tuples => tuples.ToArray();

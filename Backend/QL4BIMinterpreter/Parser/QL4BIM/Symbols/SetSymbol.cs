...
namespace QL4BIMinterpreter.QL4BIM
{
    public class SetSymbol : Symbol
    {
        ...
        public override IEnumerable<QLEntites> Tuples
        {
            get { return entityDic.Values.Select(e => new QLEntites(new []{e})); }
        }

        public QLEntites Entites => new QLEntites(entites.ToArray());
